...
public class UserServiceImpl implements UserService  {
	...
	public List<LicenseApplicationDTO> getMyApplications(Integer userId) {
		...
		if(learnerApplication!=null) {
			...
			System.out.println(learnerApplication);
			myApplications.add(new LicenseApplicationDTO(learnerApp.getId(),"Learner License",learnerApp.getStatus(),learnerApplication.getResult(),learnerApplication.getValidTill()));
		}
		if(permanentApplication !=null)
		{
			...
			myApplications.add(new LicenseApplicationDTO(permanentApp .getId(),"Permanent License",permanentApp.getStatus(),null,permanentApplication.getValidTime()));
		}
