...
public class PermanentLicenseApplicationController {
	...
	@GetMapping(value="/getELicense")
	public ResponseEntity<?> getELicense(@RequestParam Integer permanentAppId)
	{
		return ResponseEntity.status(HttpStatus.CREATED).body(permanentApplicationService.getELicense(permanentAppId));
	}
